...
\textit{Задание.}
Пусть $g \left( x \right) $ --- непрерывная функция, определённая для $x \in \left[ 0, 1 \right]$,
...
Каким нужно выбрать $n$ длч того,
...
Докажите, что если $ \sup \limits_n D \xi_n < \infty $, то
$$ \frac{S_n - MS_n}{n} \overset{P}{ \rightarrow } 0,$$
где $S_n = \xi_1 + \dotsc + \xi_n$.
