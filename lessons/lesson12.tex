...
\textit{Решение.}
Пусть $ \xi_i$ --- время между двумя последовательными успехами, а именно время от $ \left( i-1 \right) $-о успеха до $i$-го успеха включительно (рис. \ref{fig:1217}).
...
испытаний произошло ровно $r$ успехов на заданных местах $m_1, m_1 + m_2, \dotsc $\}
$=\\
= p^2 \left( 1-p \right)^{m_1 + m_2 + \dotsc + m_r - 2} = \\
= \left( p \left( 1-p \right)^{m_1 - 1} \right) \left( p \left( 1 - p \right)^{m_2 - 1} \right) \cdot \dotsc \cdot \left( p \left( 1 - p \right)^{m_r - 1} \right) $.
