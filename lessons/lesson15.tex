...
\textit{Задание.} С помощью характеристической функции вычислите моменты случайной величины с распределением $N \left( 0, \sigma^2 \right) $.
...
Представим знаменатель дроби в виде
$$2^k k! =
\left( 2 \cdot 1 \right) \cdot \left( 2 \cdot 2 \right) \cdot \dotsc \cdot \left( 2 \cdot k \right) =
\left( 2k \right)!!.$$
