...
поэтому задать её распределение означает указать значения, которые она приобретает и указать вероятности, к какими эти значения приобретаются.
...
где $A_i$ --- событие, которое состоит в том, что при $i$-том выстреле стрелок не попал в мишень.
Поскольку
