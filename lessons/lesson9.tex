...
\item $P \left( \xi = 1 \right) = 0.5, \, P \left( \xi = 3 \right) = 0.4, \, P \left( \xi = -1 \right) = 0.1$.

В сумме вероятности дают единицу, значит это все значения, которые может принимать $ \xi $.
По определению
$$F \left( x \right) =
...
График имеет вид как на рисунке \ref{fig:941}.
